  ...
  const handleDownload = () => {
    ...
    if (printWindow) {
      printWindow.document.write(`
        ...
        <html>
        <head>
          <title>Fee Payment Receipt - ${payment.student_name}</title>
          <style>
          ...
          <div className="bg-muted/50 p-4 rounded-lg print:p-3">
            ...
            <div className="grid grid-cols-2 gap-3 print:gap-2">
              <div>
                ...
                <p className="font-semibold text-base print:text-sm">{payment.student_name}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground print:text-xs">Student ID</p>
                <p className="font-semibold text-base print:text-sm">{payment.student_id}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground print:text-xs">Roll Number</p>
                <p className="font-semibold text-base print:text-sm">{payment.roll_number}</p>
              </div>
              <div>
